...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="lot-line" mode="story">
            <blockTable style="mytable" colWidths="2.8cm,5.4cm">
                <tr>
                    <td>
                        <para style="nospace"><xsl:value-of select="code"/></para> <para style="nospace"><xsl:value-of select="product"/></para>
                    </td>
                    <td>
                        <para style="nospace" t="1"><xsl:value-of select="price"/></para>
                    </td>
                </tr>
                <tr>
                    <td>
                        <barCode code="code128" xdim="28cm" ratio="2.2"><xsl:value-of select="ean13" /></barCode> 
                    </td>
                    <td>
